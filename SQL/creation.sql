...
BEGIN
    IF NEW.ID_STATION_FIN IS NOT NULL OR NEW.DATE_FIN_EMPRUNT IS NOT NULL OR NEW.HEURE_FIN_EMPRUNT IS NOT NULL OR NEW.KM_FIN_EMPRUNT IS NOT NULL THEN
        IF NEW.ID_STATION_FIN IS NULL OR NEW.DATE_FIN_EMPRUNT IS NULL OR NEW.HEURE_FIN_EMPRUNT IS NULL OR NEW.KM_FIN_EMPRUNT IS NULL THEN
...
-- ============================================================
--    Ajouts / Mise à jour / Suppression dans la base
-- ============================================================
source ./SQL/creation_maj.sql 