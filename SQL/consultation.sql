...
-- ========================================================================================================================
SELECT * FROM VELOS WHERE ID_STATION IS NOT NULL ORDER BY ID_STATION;
...
-- ========================================================================================================================
SELECT * FROM STATIONS WHERE ID_COMMUNE=2;
...
-- ========================================================================================================================
SELECT * FROM 
    (SELECT ADHERENTS.*, EMPRUNTS.ID_VELO 
        FROM ADHERENTS JOIN EMPRUNTS USING(ID_ADHERENT) 
        WHERE DATE_DEBUT_EMPRUNT=date('2021-11-12') 
        GROUP BY ADHERENTS.ID_ADHERENT, EMPRUNTS.ID_VELO) 
    AS TEMP 
